...
with open(OUTPUT_FILENAME, "w", encoding="utf-8") as f:
    ...
    f.write("format: html\n")
    f.write('subtitle: "This site automatically tracks a curated list of GitHub projects funded by NIH grant [1U24CA289073-01](https://reporter.nih.gov/project-details/10865962 ) from the National Cancer Institute to Levi Waldron at the CUNY Graduate School of Public Health and Health Policy" \n\n')
    f.write('toc: false\n')
